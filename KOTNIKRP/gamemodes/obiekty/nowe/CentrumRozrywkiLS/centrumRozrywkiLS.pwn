...
static StworzObiekty()
{
	...
	SetDynamicObjectMaterialText(ufun, 2, "Budynek został\nufndowany przez\nLuis Cotta & John_Mrucznik",  OBJECT_MATERIAL_SIZE_256x128, "Arial Black",  32,  1,  0xFFFFFFFF,  0, OBJECT_MATERIAL_TEXT_ALIGN_CENT);
	...
	SetDynamicObjectMaterialText(buil, 2, "Centrum\nRozrywki\nLS",  OBJECT_MATERIAL_SIZE_256x128, "Arial Black",  32,  1,  0xFFFFFFFF,  0, OBJECT_MATERIAL_TEXT_ALIGN_CENT);
