...
//Świat anty czita żeby dał porządny desync graczowi aby już nic nie zjebał :D
#define AC_WORLD	50005

#define MAX_IDLE_COUNT 15
...
#define MAX_MESSAGE_LENGTH 			144 		//maksymalna liczba znaków jaka może zostać wyświetlona na ekranie
#define MAX_STREAM_LENGTH 			128			//maksymalna długość linku dla PlayAudioStreamForPlayer
#define BYTES_PER_CELL 				4 			//używane w SendClientMessageF
#define SPAM_PROTECTION_VALUE 		3 			//ilość działań które można wykonać przed włączeniem ochrony antyspamowej 
#define COLOR_STRING_LENGTH			6			//długość ciągu znaków odpowiedzialna za kolor
#define NOT_FOUND					-1			//używane do strfind
...
#define COST_SN_SMS_1 10
#define COST_SN_SMS_2 20
#define COST_SN_SMS_3 30
#define COST_SN_SMS_4 40
#define COST_SN_SMS_5 50
#define MAX_LEVELINT 12

//sprunki i snacki
#define SPRUNK_COST PRICE_SPRUNK
//Inne:
#define TEAM_CYAN 1
#define TEAM_BLUE 2
#define TEAM_GREEN 3
...
//Limity:
#define MAX_FRAKCJE 100 //OLD
#define MAX_ORG     100 //OLD
...
#define CAR_AMOUNT 2000 //Maksymalna ilość wozów
...
#define LEADER_FAM 2
#define CENA_POZWOLENIE PRICE_POZWOLENIE
#define CENA_POZWOLENIE_ZYSK PRICE_POZWOLENIE_ZYSK
#define CENA_POZWOLENIE_SEJF PRICE_POZWOLENIE_SEJF
//Kary:
#define KARA_BAN 1
#define KARA_BLOCK 2
#define KARA_WARN 3
...
#define MAX_DOORS   100 //tymczasowe
...
#define FAMILY_IBIZA 18
#define FAMILY_SAD 22
...
#define ACCESS_PANEL            0b1 //Główny panel administracji
#define ACCESS_KARY             0b10 //Głowny panel kar
...
#define ACCESS_MAPPER       	0b100000000000000 //15 bit
#define ACCESS_SETSKIN          0b1000000000000000
#define ACCESS_SETNAME          0b10000000000000000
#define ACCESS_TEMPNAME         0b100000000000000000
#define ACCESS_GAMEMASTER       0b1000000000000000000
//001011011000001
#define ACCESS_OWNER            0b1111111111111111111

//31.05.2021 uprawnienia do organizacji [by renosk]

/*#define PERM_RESTAURANT     1
#define PERM_RACING         2
#define PERM_MECHANIC       4
#define PERM_WARSZTAT       8
#define PERM_GUNDEALER      16
#define PERM_DUTY           32
#define PERM_STRZELNICA     64*/
...
#define NOWY_GRACZ 6967
#define NOWY_GRACZ_POJAZD 6970
...
//NOWY SYSTEM REPORTÓW
#define MAX_REPORTS	50
#define DIALOG_REPORT_LISTA 5668
#define DIALOG_REPORT_SZCZEGOLY 5667

#define MAX_SUPPORTS 50
#define DIALOG_SUPPORT_LISTA 5666
#define DIALOG_SUPPORT_SZCZEGOLY 5665


//NOWE STATS
#define DIALOG_STATS_DOKUMENTY 6769
#define DIALOG_STATS_STATYSTYKI 5696
#define DIALOG_STATS_UMIEJETNOSCI 5669
...
#define D_JOBTYPE_BOX 1708
#define D_JOBTYPE_KURIER 1709
#define D_JOBTYPE_TAXI 1710
#define D_JOBTYPE_MEDIC 1711
...
#define DIALOGID_UNIFORM_FRAKCJA        9090
...
#define D_CHOOSE_KEEP_GROUP     9910
...
#define D_SHOP_CATEGORY                 10300
#define D_SHOP_AMOUNT                   10301
#define D_SHOP                          10302
#define D_CLOTH_CATEGORY                10303
#define D_CLOTH                         10304

//System produktów [2.7.9]

#define D_PRODUCTS_LIST                 10400
#define D_PRODUCTS_PLAYERS              10401
#define D_PRODUCTS_QUANTITY             10402
#define D_PRODUCTS_OFFER                10453

//System restauracji [2.7.9]

#define D_RESTAURANT_PANEL_OPTIONS      10403
#define D_RESTAURANT_PRODUCTS_OPTIONS   10404
#define D_RESTAURANT_PRODUCT_MANAGE     10405
#define D_RESTAURANT_PRODUCT_SETNAME    10406
#define D_RESTAURANT_PRODUCT_SETPRICE   10407
#define D_RESTAURANT_PRODUCT_CREATE_NAME 10408
#define D_RESTAURANT_PRODUCT_CREATE_VALUE2 10409
#define D_RESTAURANT_PRODUCT_CREATE_PRICE 10410
#define D_RESTAURANT_PRODUCT_CREATE_QUANT 10411
#define D_RESTAURANT_PRODUCT_CREATE_FINAL 10412
#define D_RESTAURANT_PRODUCT_SETPRICE_A   10413

#define D_RESTAURANT_BOT_LIST             10414
#define D_RESTAURANT_BOT_QUANT            10415

#define D_RESTAURANT_PRODUCT_BUYQUANT     10416
#define D_RESTAURANT_PRODUCT_BUYCONFIRM   10417
#define D_RESTAURANT_PRODUCT_TYPE         10418

#define D_NEWRADIO 10450
#define D_ZBROJOWNIA 10451
#define D_APTEKA 10452

#define D_TUNE_PANEL                10500
#define D_TUNE_PANEL_SHOWCASE       10501
#define D_TUNE_PANEL_NITRO          10502
#define D_TUNE_PANEL_STOCK          10503
#define D_TUNE_PANEL_SELECT         10504
#define D_TUNE_PANEL_FINISH_CONFIRM 10505
#define D_TUNE_PANEL_SELECT_BUMPER  10506
#define D_TUNE_PANEL_SELECT_NEON    10507
#define D_TUNE_PANEL_SELECT_PAINT   10508
#define D_TUNE_BASKET               10509
#define D_TUNE_PANEL_UPGRADE        10510
#define D_DRWAL                     10550

#define D_SHOWWARNS                 10551
#define D_SHOWWARNS_CONFIRM         10552
#define D_BILBRENT1                 10553
#define D_BILBRENT2                 10554
#define D_BILBRENT3                 10555

#define DIALOG_FOREX                10560 
#define DIALOG_FOREX_WYSTAWA        10561
#define DIALOG_FOREX_WYSTAWA_1      10562
#define DIALOG_FOREX_WYSTAWA_2      10563
#define DIALOG_FOREX_BUY            10564
#define DIALOG_FOREX_BUY_CONFIRM    10565 
...
#define TEXT_D_PANEL_KARY "Nadaj karę\nZdejmij karę\nWyszukiwanie danych gracza"
...
#define CAR_OWNER_PLAYER    2
#define CAR_OWNER_JOB       3
#define CAR_OWNER_SPECIAL   4
#define CAR_OWNER_PUBLIC    5
#define CAR_OWNER_GROUP     CAR_OWNER_FRACTION
