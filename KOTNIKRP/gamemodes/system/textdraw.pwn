...
//// hud gry ///
new Text:HUDTXDINFO[MAX_PLAYERS];
////////////////
...
LoadTXD()
{
    ...
    TextDrawColour(Loading_Title, -1);
    ...
    Loading_Info = TextDrawCreate(320.000000, 233.296279, "INICJALIZACJA ...");
    TextDrawLetterSize(Loading_Info, 0.230000, 1.052444);
    TextDrawAlignment(Loading_Info, 2);
    TextDrawColour(Loading_Info, -1);
	...
	TextDrawColour(TXD_Worek,0x000000ff);
	...
	TextDrawColour(BottomBarTXD, -256);
	...
	new txd[58];
	format(txd, sizeof(txd), "~y~M-RP "VERSION);
	ServerVersionTXD = TextDrawCreate(36.000000, 436.000000, txd);
	TextDrawFont(ServerVersionTXD, 3);
	...
	TextDrawColour(ServerVersionTXD, 0xFFD700D7);
	...
	AdvertTXD = TextDrawCreate(85.000000, 436.000000, "_");
	TextDrawFont(AdvertTXD, 2);
	TextDrawLetterSize(AdvertTXD, 0.166666, 1.049999);
	TextDrawTextSize(AdvertTXD, 413.000000, 76.500000);
	TextDrawSetOutline(AdvertTXD, 0);
	TextDrawSetShadow(AdvertTXD, 0);
	TextDrawAlignment(AdvertTXD, 1);
	TextDrawColour(ServerVersionTXD, 0x999999FF);
	TextDrawBackgroundColor(AdvertTXD, 0);
	TextDrawBoxColor(AdvertTXD, 213);
	TextDrawUseBox(AdvertTXD, 0);
	TextDrawSetProportional(AdvertTXD, 1);
	TextDrawSetSelectable(AdvertTXD, 0);
...
BottomBar(playerid, show = 1)
{
	if(!show)
	{
		...
		TextDrawHideForPlayer(playerid, AdvertTXD);
		return 1;
	}
	...
	TextDrawShowForPlayer(playerid, AdvertTXD);
	return 1;
}

LoadingShow(playerid, status = 0)
{
...
KaryTXDLoadForPlayer(playerid)
{
	...
	PlayerTextDrawColour(playerid, Kary[playerid], -1);
...
SN_Message_Load(playerid)
{
	...
	PlayerTextDrawColour(playerid, SN_MESS[playerid], -1);
...
Stats_TXD_Load(playerid)
{
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Background[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_SkinShow[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_UID[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_LVL[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_NICK[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_PLEC[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Pochodzenie[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Zdrowie[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Kasa[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Bank[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Telefon[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_KP[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Wiek[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Slub[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_OnLine[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Respekt[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Rodzina[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_RodzinaRanga[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_BOID[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_BMID[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Skin[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Dom[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Warny[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Praca[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Drugs[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Admin[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Mats[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Fraction[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_FractionRank[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Przestepstwa[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Zabic[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Smierci[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_ZmienNick[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_AresztTime[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_WozKlucz[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Pkt[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Sila[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_WL[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_WantedDeath[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Ryba[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Data[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Czas[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_LogoMRP[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Linia_01[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Linia_02[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Linia_03[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_Linia_04[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TXDSTATS_ZnakWodny[playerid], -1);
...
LoadTextDraws(playerid)
{
    ...
    PlayerTextDrawColour(playerid, TAXI_DIST[playerid], -1);
    ...
    PlayerTextDrawColour(playerid, TAXI_COST[playerid], -1);
    ...
    PlayerTextDrawColour(playerid, CRUISECONTROL_AMOUNT[playerid], -1);
    ...
    PlayerTextDrawColour(playerid, TextInformacyjny[playerid], -1);
    ...
    PlayerTextDrawColour(playerid, TextOferta1[playerid], -1);
	...
	PlayerTextDrawColour(playerid, TextOferta1[playerid], 0x80FF00FF);
    KaryTXDLoadForPlayer(playerid); 
    SN_Message_Load(playerid);
    Stats_TXD_Load(playerid);
...
NG_CreateGateTD()
{
    ...
    TextDrawColour(NG_GateTD[0], 567069898);
    ...
    TextDrawColour(NG_GateTD[7], 869020671);
...
fMSGBOX_InitForPlayer(playerid, title[], icon[])
{
    ...
    PlayerTextDrawColour(playerid, MSGBOXtd_Title[playerid], -1);
    ...
    PlayerTextDrawColour(playerid, MSGBOXtd_Icon[playerid], -1);
...
fMSGBOX_Init()
{
    ...
    TextDrawColour(MSGBOXtd_Ver, 16711935);
    ...
    TextDrawColour(MSGBOXtd_Kubi, 51);
...
ZonePTXD_Load(playerid)
{
    ...
    PlayerTextDrawColour(playerid, ZonePTXD_Name[playerid], -1);
    ...
    PlayerTextDrawColour(playerid, ZonePTXD_Cash[playerid], -1);
    ...
    PlayerTextDrawColour(playerid, ZonePTXD_Area[playerid], -1);
    ...
    PlayerTextDrawColour(playerid, ZonePTXD_Member[playerid], -1);
...
ZoneTXD_Load()
{
    ...
    TextDrawColour(ZoneTXD[1], 16777215);
...
stock SpeedoHide(playerid)
{
	for(new i = 0; i < 8; i++)
	{
		PlayerTextDrawHide(playerid, SpeedometerPDP[playerid][i]);
	}
	for(new i = 0; i < 13; i++)
	{
...
Speedo_PlayerLoad(playerid)
{
	...
	PlayerTextDrawColour(playerid, SpeedometerPDP[playerid][0], -13827864);
	...
	PlayerTextDrawColour(playerid, SpeedometerPDP[playerid][1], -13827864);
	...
	PlayerTextDrawColour(playerid, SpeedometerPDP[playerid][2], -141);
	...
	PlayerTextDrawColour(playerid, SpeedometerPDP[playerid][3], -141);
	...
	PlayerTextDrawColour(playerid, SpeedometerPDP[playerid][4], 16728319);
	...
	PlayerTextDrawColour(playerid, SpeedometerPDP[playerid][5], -12713729);
	...
	PlayerTextDrawColour(playerid, SpeedometerPDP[playerid][6], -141);
	...
	PlayerTextDrawColour(playerid, SpeedometerPDP[playerid][7], -91);
...
Speedo_PlayerUnload(playerid)
{
    for(new i = 0; i < 8; i++)
	{
		PlayerTextDrawDestroy(playerid, SpeedometerPDP[playerid][i]);
	}
}
...
Oil_LoadTXD()
{
    ...
    TextDrawColour(OilTXD_BG[1], 268435455);
...
Oil_LoadPTXD(playerid)
{
    ...
    PlayerTextDrawColour(playerid, OilPTXD_Arrow[0][playerid], 16777215);
    ...
    PlayerTextDrawColour(playerid, OilPTXD_Arrow[1][playerid], 16777215);
    ...
    PlayerTextDrawColour(playerid, OilPTXD_Arrow[2][playerid], 16777215);
    ...
    PlayerTextDrawColour(playerid, OilPTXD_Arrow[3][playerid], 16777215);
    ...
    PlayerTextDrawColour(playerid, OilPTXD_Arrow[4][playerid], 16777215);
