...
command_pizzaboy_Impl(playerid)
{
    if(PlayerInfo[playerid][pJob] == 11)
    {
        if(!Pizzaboy_Active[playerid])
        {
            ...
            } else return sendErrorMessage(playerid, "Wykonujesz już swoje zadanie!");
        } else {
            GameTextForPlayer(playerid, "Zakonczono prace!", 2500, 4);
            Pizzaboy_End(playerid);
        }
    } else return sendTipMessage(playerid, "Musisz najpierw się zatrudnić w tej pracy! Dolacz do tej pracy w urzędzie pracy");
