...
hook OnGameModeInit()
{ 
	Create3DTextLabel("Praca Dostawcy Pizzy!\n{FFFFFF}(/{929292}pizzaboy{FFFFFF}) aby pracować\n(/{929292}dolacz{FFFFFF}) aby się zatrudnić", 0xFFA500AA, Pizzaboy_Main_Locations[0][0], Pizzaboy_Main_Locations[0][1], Pizzaboy_Main_Locations[0][2]+0.5000, 30, 0, 0);
    return 1;
}
