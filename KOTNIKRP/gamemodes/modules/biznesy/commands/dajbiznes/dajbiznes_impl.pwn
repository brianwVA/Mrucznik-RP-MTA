...
{
    if(valueBiz <= 0 || valueBiz >= MAX_BIZNES || valueBiz == INVALID_BIZ_ID)
    {
    ...
    {
        sendErrorMessage(playerid, "Ten biznes już do kogoś należy!"); 
        return 1;
    }
    ...
    Log(adminLog, WARNING, "%s dal biznes %s graczowi %s",
