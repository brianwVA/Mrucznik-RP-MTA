...
{ 
	...
	CreateLogEx(sprintf("logi/%s/combat", logdate));
	CreateLogEx(sprintf("logi/%s/house", logdate));
	...
	combatLog = CreateLog(sprintf("logi/%s/combat", logdate), false);
	houseLog = CreateLog(sprintf("logi/%s/house", logdate), false);
