...
ugotuj_OnDialogResponse(playerid, listitem)
{
    ...
    SendClientMessage(playerid,COLOR_LIGHTBLUE, sprintf("* Ugotowałes potrawę: %s, ważącą %dg.",
        name, weight   
    ));
...
command_ugotuj_Impl(playerid)
{
    ...
    {
        sendErrorMessage(playerid, "Nie jesteś w miejscu przeznaczonym do gotowania (Cluckin Bell / Burger Shot / Pizzeria).");
        return 1;
    }
