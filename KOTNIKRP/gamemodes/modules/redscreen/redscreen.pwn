...
hook OnPlayerTakeDamage(playerid, issuerid, Float:amount, weaponid)
{
	if(g_PlayerTextDraw[playerid] == PlayerText:INVALID_TEXT_DRAW)
	{
		...
		PlayerTextDrawColour(playerid, g_PlayerTextDraw[playerid], 0x772222FF);
	...
	PlayerTextDrawColour(playerid, g_PlayerTextDraw[playerid], AlphaConvert(0x552222FF, g_Alpha[playerid]));
