...
{
    if(!CheckPlayerPerm(playerid, PERM_GANG)) return sendTipMessageEx(playerid, COLOR_GRAD2, "Graffiti tylko dla gangów!");
    new frac;
    ...
    if(strcmp(opcja,"stworz",true) == 0)
    {
        ...
        if(GetPVarInt(playerid, "zoneid") == -1 || (ZoneControl[GetPVarInt(playerid, "zoneid")] != frac && ZoneControl[GetPVarInt(playerid, "zoneid")]-100 != frac))
        {                
        ...
        {
            sendTipMessageEx(playerid, -1, "Musisz być na zewnąrz.");
            return 1;
        }
    ...
    else if(strcmp(opcja,"usun",true) == 0)
    {
        ...
        {
            sendTipMessage(playerid, "Nie znaleziono graffiti w pobliżu. (podejdź bliżej)");
        }
    }
    ...
    else if(strcmp(opcja,"edytuj", true) == 0)
    {
        ...
        if(i!=INVALID_GRAFID)
        {
            ...
            {
                sendTipMessage(playerid, "Graffiti nie należy do ciebie.");
            }
        }
        else
        {
