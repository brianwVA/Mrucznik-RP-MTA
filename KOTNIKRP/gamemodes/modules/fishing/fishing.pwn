	...
	if(IsPlayerConnected(playerid))
	{
		...
		switch (fish)
		{
		    case 1:
		    {
				...
				mysql_tquery_format("UPDATE `mru_ryby` SET `Fish1` = 'None', `Weight1` = '0', `Fid1` = '0' WHERE `Player` = '%d'", PlayerInfo[playerid][pUID]);
		    }
		    case 2:
		    {
		        strmid(Fishes[playerid][pFish2], string, 0, strlen(string), 255);
				...
				mysql_tquery_format("UPDATE `mru_ryby` SET `Fish2` = 'None', `Weight2` = '0', `Fid2` = '0' WHERE `Player` = '%d'", PlayerInfo[playerid][pUID]);
		    }
		    case 3:
		    {
		        strmid(Fishes[playerid][pFish3], string, 0, strlen(string), 255);
				...
				mysql_tquery_format("UPDATE `mru_ryby` SET `Fish3` = 'None', `Weight3` = '0', `Fid3` = '0' WHERE `Player` = '%d'", PlayerInfo[playerid][pUID]);
		    }
		    case 4:
		    {
		        strmid(Fishes[playerid][pFish4], string, 0, strlen(string), 255);
				...
				mysql_tquery_format("UPDATE `mru_ryby` SET `Fish4` = 'None', `Weight4` = '0', `Fid4` = '0' WHERE `Player` = '%d'", PlayerInfo[playerid][pUID]);
		    }
		    case 5:
		    {
		        strmid(Fishes[playerid][pFish5], string, 0, strlen(string), 255);
				...
				mysql_tquery_format("UPDATE `mru_ryby` SET `Fish5` = 'None', `Weight5` = '0', `Fid5` = '0' WHERE `Player` = '%d'", PlayerInfo[playerid][pUID]);
		    }
		}
	}
	return 1;
