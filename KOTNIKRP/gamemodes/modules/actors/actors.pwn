...
//Opis:
/*
	Skrypt umożliwiający tworzenie Aktorów.
	Pozwala na interakcję z nimi inGame.

	Commands:
	>/setactoranim - pozwala na ustawienie animacji dla actora
	>/selactor - pozwala zaznaczyć actora, wyświetla GUI umożliwiające edycje i ustalanie wartości [Trwają prace]

	Odwołania:
	>Submodule obiekty - plik ActorsOnWorld - zawiera wszystkich stworzonych actorów na potrzeby świata K-RP. 
