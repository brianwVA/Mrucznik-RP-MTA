...
command_ulecz_Impl(playerid, giveplayerid)
{
    ...
    {
        sendTipMessageEx(playerid, COLOR_GRAD1, "Nie możesz uleczyć samego siebie!");
        return 1;
    }
    ...
    {
        sendErrorMessage(playerid, "Nie jesteś w pojeździe medycznym / Chopper / szpitalu !");
        return 1;
    }
    ...
    sendTipMessageEx(giveplayerid, TEAM_GREEN_COLOR, sprintf("Zostałeś uleczony przez medyka %s.", GetNick(playerid)));
    return 1;
}
