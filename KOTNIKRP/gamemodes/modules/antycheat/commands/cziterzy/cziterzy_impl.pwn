...
command_cziterzy_Impl(playerid)
{
    if(PlayerInfo[playerid][pAdmin] >= 1 || PlayerInfo[playerid][pNewAP] >= 1 || IsAScripter(playerid)) 
    {
        ...
        {
            SendClientMessage(playerid, COLOR_LIGHTBLUE, "Wyłączyłeś listę potencjalnych cziterów.");
            HidePotentialCheatersTxd(playerid);
        }
        else
        {
            SendClientMessage(playerid, COLOR_LIGHTBLUE, "Włączyłeś listę potencjalnych cziterów.");
