...
NowaWybieralka_CreateTxd()
{
    ...
    TextDrawColour(NowaWybieralka_Left, -1378294017);
    ...
    TextDrawColour(NowaWybieralka_Select, -1378294017);
    ...
    TextDrawColour(NowaWybieralka_Right, -1378294017);
...
NowaWybieralka_ClickedTxd(playerid, Text:clickedid)
{
	...
	if(clickedid == NowaWybieralka_Select)
	{
		...
		else
		{
	        ...
	        Wchodzenie(playerid);
	        sendTipMessageEx(playerid, COLOR_P@, sprintf("Kupiłeś skin %d za $5", PlayerInfo[playerid][pSkin]));
	        ZabierzKaseDone(playerid, 5);
		}
		TogglePlayerControllable(playerid, 1);		

		//sendTipMessageEx(playerid, COLOR_P@, sprintf("Kupiłeś skin %d za $5000", PlayerInfo[playerid][pModel]));
