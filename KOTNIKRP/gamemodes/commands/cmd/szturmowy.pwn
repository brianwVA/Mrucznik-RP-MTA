    ...
    if(IsPlayerConnected(playerid))
    {
		...
		if(IsAPolicja(playerid))
		{
			...
			|| PlayerToPoint(3.5, playerid, 597.1039,-1474.2688,80.4357))//nowe FBI by ubunteq
			{
				...
				{
					format(string, sizeof(string), "* %s wyciąga z szafki i ubiera zestaw szturmowy.", sendername);
				...
				else if(OnDuty[playerid] > 0 && DodatkiPD[playerid] == 1)
				{
                	...
                	format(string, sizeof(string), "* %s ściąga z siebie zestaw szturmowy i chowa do szafki.", sendername);
					ProxDetector(30.0, playerid, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
		...
		{
			sendErrorMessage(playerid, "Nie jesteś ze służb porządkowych !");
			return 1;
		}
	}
	return 1;
