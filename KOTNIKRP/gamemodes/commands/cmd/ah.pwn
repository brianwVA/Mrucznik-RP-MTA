...
YCMD:ah(playerid, params[], help)
{
	...
	if (PlayerInfo[playerid][pAdmin] >= 5000)
	{
		...
		SendClientMessage(playerid, COLOR_GRAD6,"*** 5000 *** /zrobdom /lzrobdom /usundom /blokujdom /resetsejfhasla /zapiszkonta");
	...
	{
		SendClientMessage(playerid, COLOR_WHITE,"*** Jesteś koxem przez X ***");
		...
		SendClientMessage(playerid, COLOR_GRAD6,"*** 5000 **  /msgbox /restart /setarmor /setserverpass /checktimers");
