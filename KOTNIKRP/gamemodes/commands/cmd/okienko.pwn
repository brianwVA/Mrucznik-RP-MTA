...
YCMD:okienko(playerid, params[], help)
{
	if (IsAUrzednik(playerid))
	{
		if(IsPlayerConnected(playerid))
		{
			...
			{
				sendErrorMessage(playerid, "Nie jesteś przy żadnym z okienek!");
				return 1;
			}
			...
			ShowPlayerDialogEx(playerid,99,DIALOG_STYLE_LIST,"Którą tablicę wywieszasz:","Dopasuj do rangi\nEgzaminy Praktyczne\nEgzaminy Teoretyczne\nKurs na prawo jazdy\nRejestracja\nZ/W\nZamknięte","Wywieś","Zamknij");
			return 1;
		}
	}
	else
