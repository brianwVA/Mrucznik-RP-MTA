...
YCMD:od(playerid, params[], help)
{
	...
	{
		sendErrorMessage(playerid, "Już prowadzisz rozmowę.");
		return 1;
	}
	...
	sendTipMessageEx(callerid, COLOR_GRAD2, "Twój rozmówca odebrał telefon.");
	sendTipMessageEx(playerid, COLOR_GRAD2, "Odebrałeś telefon.");
