...
YCMD:kamerau(playerid, params[], help)
{
    ...
    {
        if(IsABOR(playerid) || GroupPlayerDutyRank(playerid) >= 2)
        {
            new kamid;
            if( sscanf(params, "d", kamid))
            {
                sendTipMessage(playerid, "Użyj /kamerau [1-4]");
                sendTipMessage(playerid, "[5] = Wyłączenie podglądu");
                return 1;
            }
            if(IsPlayerInRangeOfPoint(playerid, 3.0, 1456.8298,-1782.6688,77.9502) || IsPlayerInRangeOfPoint(playerid, 3.0, 1453.1586,-1785.0184,82.3912) || IsPlayerInRangeOfPoint(playerid, 3.0, 1449.4949,-1805.1057,82.3912) || IsPlayerInRangeOfPoint(playerid, 3.0, 1450.6265,-1818.7275,85.7253))
            {
                ...
                if(kamid == 1)
                {
                    ...
                    sendTipMessage(playerid, "[KAMERA 1][Urząd Miasta Los Santos] Hol wejściowy");
                ...
                } else if(kamid == 2)
                {
                    ...
                    sendTipMessage(playerid, "[KAMERA 2][Urząd Miasta Los Santos] Okienka 5-8");
                    TogglePlayerControllable(playerid, 0);
                ...
                } else if(kamid == 3)
                {
                    ...
                    sendTipMessage(playerid, "[KAMERA 3][Urząd Miasta Los Santos] Okienka 1-4");
                    TogglePlayerControllable(playerid, 0);
                } else if(kamid == 4)
                {
                    ...
                    sendTipMessage(playerid, "[KAMERA 4][Urząd Miasta Los Santos] Duży hol");
                    TogglePlayerControllable(playerid, 0);
                } else if(kamid == 5)
                {
                    ...
                    sendTipMessage(playerid, "Wyłączyłeś podgląd kamer");
                }
        ...
        {
            sendErrorMessage(playerid, "Nie posiadasz dostępu do tej komendy!");
        }
