YCMD:stworzbrame(playerid, params[], help)
{
	...
	if(sscanf(params, "dffdd", model, speed, range, perm_type, perm_id))
		return sendTipMessage(playerid, "Użyj: /stworzbrame [model] [prędkość] [odległość] [typ właściciela (0 - wszyscy, 1 - grupa)] [id]");
	...
	if(range > 30.0)
		return sendTipMessage(playerid, "Za duża odległość.");
	...
	sendTipMessage(playerid, "Wybierz pozycje początkową bramy.");
	return 1;
}