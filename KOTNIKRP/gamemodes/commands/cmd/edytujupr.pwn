...
YCMD:edytujupr(playerid, params[], help)
{
    ...
    if(Uprawnienia(id, ACCESS_DELETEORG)) strcat(str, "{00FF00}+{FFFFFF} Nieużywane\n");
    else strcat(str, "{FF0000}-{FFFFFF} Nieużywane\n");
    ...
    if(Uprawnienia(id, ACCESS_EDITPERM)) strcat(str, "{00FF00}+{FFFFFF} Edycja uprawnień\n");
    else strcat(str, "{FF0000}-{FFFFFF} Edycja uprawnień\n");
    ...
    ShowPlayerDialogEx(playerid, D_PERM, DIALOG_STYLE_LIST, "Edycja uprawnień", str, "Zmień", "Wyjdź");
    return 1;
}
