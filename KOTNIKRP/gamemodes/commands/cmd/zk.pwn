...
YCMD:zk(playerid, params[], help)
{
    if(gPlayerLogged[playerid] == 1)
	{
		...
		{
			sendTipMessage(playerid, "Użyj /zabierzkluczyki(/zk) [numer wozu]");
			return 1;
		}
        ...
        if(CarData[PlayerInfo[playerid][pCars][numerp]][c_Keys] == 0) return sendErrorMessage(playerid, "Nikomu nie dawałeś kluczyków od tego pojazdu.");
