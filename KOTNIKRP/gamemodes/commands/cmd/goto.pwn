...
YCMD:goto(playerid, params[], help)
{
    ...
    if(IsPlayerConnected(playerid))
    {
		...
		{
			sendTipMessage(playerid, "Użyj /to [playerid/CzęśćNicku]");
			return 1;
		}
		...
		{
			if (PlayerInfo[playerid][pAdmin] >= 1 || PlayerInfo[playerid][pNewAP] >= 1 || PlayerInfo[playerid][pZG] >= 1 || Uprawnienia(playerid, ACCESS_PANEL) || IsAScripter(playerid) || IsAGameMaster(playerid))
			{
