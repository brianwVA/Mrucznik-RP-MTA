...
YCMD:noa(playerid, params[], help)
{
	...
	if(IsANoA(playerid) && GroupPlayerDutyRank(playerid) >= 6)
	{
		...
		if(isnull(params))
		{
			sendTipMessage(playerid, "Użyj /FDU [tresc]");
			return 1;
		}
		if(GetPlayerAdminDutyStatus(playerid) == 1)
		{
			sendErrorMessage(playerid, "Dobry admin nie powinien robić OOC w IC! Napisz to poprzez /o treść");
			return 1;
		}
	...
	{
		sendErrorMessage(playerid,"Nie jesteś z FDU/nie masz 6 rangi");
	}
	return 1;
}
