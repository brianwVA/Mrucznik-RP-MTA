...
YCMD:podszyjsie(playerid, params[], help)
{
    ...
    if(IsPlayerConnected(playerid))
    {
		...
		{
		    ShowPlayerDialogEx(playerid,DIALOGID_PODSZYJ,DIALOG_STYLE_LIST,"Podszyj się.","FBI\n""Grove\n""Ballas\n""ICC\n""Yakuza\n""Latin Kings","Dalej",""); //zmień dialogid
		}
		else
		{
            SendClientMessage(playerid, COLOR_GRAD2, "	Nie możesz się podszywać!");
		}
	}
	*/
	return 1;
