...
{
    if(!((IsAMedyk(playerid) && GroupPlayerDutyRank(playerid) >= 2))) return SendClientMessage(playerid, COLOR_GRAD1, "   Nie należysz do LSMC albo nie masz 2 rangi.");
    ...
    SetDynamicObjectMaterialText(VAR_LSMCTopic, 0, tekscik, OBJECT_MATERIAL_SIZE_512x128, "Comic Sans MS", 40, 0, 0xFF000000, 0xFFFFFFFF, OBJECT_MATERIAL_TEXT_ALIGN_CENT);
