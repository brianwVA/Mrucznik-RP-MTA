...
YCMD:skille(playerid, params[], help)
{
    ...
    Item_Add("Materiały", ITEM_OWNER_TYPE_PLAYER, PlayerInfo[playerid][pUID], ITEM_TYPE_MATS, 0, 0, true, playerid, 50000, ITEM_NOT_COUNT);

    sendTipMessage(playerid, "[Dostałeś skille 5 w każdej dziedzinie i 50000 mats]");
