...
YCMD:respawncar(playerid, params[], help)
{
    ...
    new v;
    if(sscanf(params, "d", v)) return sendTipMessage(playerid, "Użyj /respawncar [ID pojazdu]");
    ...
    {
        Log(adminLog, WARNING, "Admin %s respawnował pojazd %s", GetPlayerLogName(playerid), GetVehicleLogName(v));
        RespawnVehicleEx(v);
