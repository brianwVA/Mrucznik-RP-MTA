...
YCMD:otworzlinie(playerid, params[], help)
{
    ...
    {
        new lLine;
        if(sscanf(params, "d", lLine)) return sendTipMessage(playerid, "Podaj numer lini, którą chcesz otworzyć np. 100 lub 150");
        ...
        {
            return sendErrorMessage(playerid, "Możesz otworzyć jedynie linie 100-110-120-130-140-150!");
        }
        gSNLockedLine[lLine-100] = false;
        format(lStr, 128, "San-SMS: Linia %d została otworzona przez %s", lLine, GetNick(playerid));
