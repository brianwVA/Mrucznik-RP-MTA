YCMD:reporty(playerid, params[], help)
{
    if(IsPlayerConnected(playerid))
    {
        ...
        if(PlayerInfo[playerid][pAdmin] >= 1 || PlayerInfo[playerid][pZG] >= 3 || IsAScripter(playerid) || PlayerInfo[playerid][pNewAP] >= 1){
            ...
            strcat(tekst, "{d9d9d9}RepID\t{d9d9d9}Zgłaszający\t{d9d9d9}Zgłoszony" );
            ...
            ShowPlayerDialogEx(playerid, DIALOG_REPORT_LISTA, DIALOG_STYLE_TABLIST_HEADERS, "{d9d9d9}Zgłoszenia - REPORTY", tekst, "Wybierz", "Wyjdź" );
		}
		else
		{
