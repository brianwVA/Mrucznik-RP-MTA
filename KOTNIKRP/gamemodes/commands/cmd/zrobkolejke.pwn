...
YCMD:zrobkolejke(playerid, params[], help)
{
    ...
    if(!VAR_Kolejka)
    {
        ...
        VAR_Kolejka=true;
        SendClientMessageToAll(0x75C8B7, "Administrator uruchomił kolejkę. Jeżeli masz jakąś sprawę, wpisz /kolejka");
    }
    else
    {
        ...
        SendClientMessageToAll(0x75C8B7, "Administrator zakończył kolejkę.");
