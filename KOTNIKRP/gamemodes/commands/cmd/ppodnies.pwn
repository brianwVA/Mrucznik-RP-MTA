...
YCMD:ppodnies(playerid, params[])
{
	...
	if(InfoSkate[playerid][sActive]) { SendClientMessage(playerid, COLOR_BIALY, "[Magazynier] Nie możesz wykonywać tej pracy z deskorolką!."); return 1; }
	if(IsPlayerInRangeOfPoint(playerid,2.0,890, -1218.15, 16.97) || IsPlayerInRangeOfPoint(playerid,2.0,2171.96, -2250.89, 13.30) || IsPlayerInRangeOfPoint(playerid,3.0,2294.3201,-1922.8436,13.5469))
	{
