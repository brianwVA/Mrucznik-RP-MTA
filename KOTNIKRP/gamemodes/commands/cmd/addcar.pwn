...
YCMD:addcar(playerid, params[], help)
{
    ...
    if(sscanf(params, "ddd", model, color1, color2)) return sendTipMessage(playerid, "Użyj /addcar [Model] [Kolor] [Kolor]");
    ...
    Log(adminLog, WARNING, "Admin %s stworzył Auto o UID %d model %d", GetPlayerLogName(playerid), CarData[id][c_UID], model);
    return 1;
}
