...
///{
	...
	//{
		...
		//{
		//	sendTipMessage(playerid, "Jesteś uciszony! Nie możesz mówić"); 
	//		return 1;
	//	}
	//	if(GetPlayerAdminDutyStatus(playerid) == 1)
	//	{
	//		sendErrorMessage(playerid, "Dobry admin nie powinien robić OOC w IC! Użyj /b [treść]"); 
	//		return 1;
	//	}
	//	if(isnull(params))
	//	{
		//	sendTipMessage(playerid, "Użyj /(l)ocal [tekst]");
			//return 1;
		//}
...
{
	if(isnull(params)) return sendTipMessage(playerid, "Użyj /szept [tekst]");
	new string[128];
