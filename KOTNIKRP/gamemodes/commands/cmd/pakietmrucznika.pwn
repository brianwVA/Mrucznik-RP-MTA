...
YCMD:pakietmrucznika(playerid, params[], help)
{
    ...
    if(gettime() < GetPVarInt(playerid, "pakietl")) return sendTipMessage(playerid, "{dafc10}Możesz używać tego co 60s");
    ...
    sendTipMessageEx(playerid, COLOR_PAPAYAWHIP, "[Nie spam tą komendą inaczej dostaniesz bana]");
