...
g_SAMPSyscallPrototypes = {
	...
	MRP_MirrorStreamerObject = {'i', 'i', 'f', 'f', 'f', 'f', 'f', 'f', 'i', 'i', 'f'},
	MRP_MirrorStreamerPickup = {'i', 'i', 'i', 'f', 'f', 'f', 'i', 'i'},
	MRP_DestroyStreamerObject = {'i'},
	MRP_SetStreamerObjectPos = {'i', 'f', 'f', 'f'},
	MRP_SetStreamerObjectRot = {'i', 'f', 'f', 'f'},
	MRP_MoveStreamerObject = {'i', 'f', 'f', 'f', 'f', 'f', 'f', 'f'},
	MRP_SetStreamerObjectMaterial = {'i', 'i', 'i', 's', 's', 'i'},
	MRP_DestroyStreamerPickup = {'i'},
	...
	SetVehicleDoorState = {'v', 'i', 'i', 'b'},
	GetVehicleLightState = {'v', 'i'},
	SetVehicleLightState = {'v', 'i', 'i'},
	GetVehicleTaxiLightState = {'v'},
	SetVehicleTaxiLightState = {'v', 'b'},
	GetVehicleWheelState = {'v', 'i'},
	SetVehicleWheelState = {'v', 'i', 'i', 'i', 'i'},
	GetVehiclePanelState = {'v', 'i'},
	SetVehiclePanelState = {'v', 'i', 'i', 'b'},
	GetVehicleLandingGearState = {'v'},
	SetVehicleLandingGearState = {'v', 'b'},
	GetVehicleOverrideLights = {'v'},
	SetVehicleOverrideLights = {'v', 'i'},
	GetVehicleHeadLightColor = {'v'},
	SetVehicleHeadLightColor = {'v', 'c'},
	...
	-- buildings
	RemoveBuilding = {'i', 'f', 'f', 'f', 'f'},
	RestoreBuildingForPlayer = {'p', 'i', 'f', 'f', 'f', 'f', client = true},
	RestoreAllBuildingsForPlayer = {'p', client = true},
	RestoreBuilding = {'i', 'f', 'f', 'f', 'f'},
	RestoreAllBuildings = {},
	...
	GetSkyGradient = {'r', 'r'},
	SetSkyGradient = {'i', 'i'},
	GetWindVelocity = {'r', 'r', 'r'},
	SetWindVelocity = {'f', 'f', 'f'},
	GetFogDistance = {},
	SetFogDistance = {'f'},
	SetWeatherBlended = {'i'},
	GetMinuteDuration = {},
