...
--
-- Temporary view structure for view `view_organizacje`
--

DROP TABLE IF EXISTS `view_organizacje`;
/*!50001 DROP VIEW IF EXISTS `view_organizacje`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_organizacje` AS SELECT 
 1 AS `UID`,
 1 AS `Nick`,
 1 AS `Lider`,
 1 AS `LeaderValue`,
...
--
-- Final view structure for view `view_organizacje`
--
