...
--
-- Temporary view structure for view `view_pojazdy_rodzin`
--

DROP TABLE IF EXISTS `view_pojazdy_rodzin`;
/*!50001 DROP VIEW IF EXISTS `view_pojazdy_rodzin`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_pojazdy_rodzin` AS SELECT 
 1 AS `UID`,
 1 AS `owner`,
 1 AS `model`,
 1 AS `nazwa_modelu`,
...
--
-- Final view structure for view `view_pojazdy_rodzin`
--
