...
DROP TABLE IF EXISTS `mru_partie_akcje`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mru_partie_akcje` (
  `UID` int NOT NULL AUTO_INCREMENT,
  `partia_id` int NOT NULL,
  `podpisy` smallint unsigned NOT NULL,
  `nazwa` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_polish_ci NOT NULL,
