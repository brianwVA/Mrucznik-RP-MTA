...
CREATE TABLE `mru_bany` (
  ...
  `dostal` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'brak',
  ...
  KEY `IP` (`IP`)
) ENGINE=InnoDB AUTO_INCREMENT=1331 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_polish_ci;
...
-- Dump completed on 2026-01-12 18:03:40
